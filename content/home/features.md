...
[[feature]]
  ...
  description = "**3 ώρες εξ αποστάσεως, ζωντανών μαθημάτων, την εβδομάδα** μέσω της πλατφόρμας <a href=\"https://zoom.us\" _target=\"blank\">Zoom</a>."
  
[[feature]]
  icon = "sitemap"
  icon_pack = "fas"
  name = "Ηλεκτρονική πλατφόρμα"
  description = "Πλήρης εκπαιδευτική πλατφόρμα (<a href=\"https://moodle.org\" _target=\"blank\">Moodle</a>), ασύγχρονης εκπαίδευσης, με **quiz**, **εκπαιδευτικό υλικό**, **συνοδευτικά βίντεο** και **φόρουμ αλληλεπίδρασης**."  
