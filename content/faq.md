...
Το πρόγραμμα περιλαμβάνει σύγχρονη (ζωντανές εξ αποστάσεως διαλέξεις) και ασύγχρονη (ηλεκτρονική πλατφόρμα) εκπαίδευση που συνδυαστικά δημιουργούν ένα πακέτο αποδοτικής μάθησης.
