...
Η **σύγχρονη εκπαίδευση** αποτελείται από 3 ώρες εξ αποστάσεως μαθημάτων την εβδομάδα από το συγγραφέα Γιώργο Παναγιωτακόπουλο, σε καθορισμένες ημέρες και ώρες (2 φορές από μιάμιση ώρα – Τετάρτη και Παρασκευή). Στα εξ αποστάσεως μαθήματα συμμετέχουν όλοι οι μαθητές του προγράμματος (έως 10 άτομα ανά τμήμα).
Επίσης, συμπεριλαμβάνονται σεμινάρια διαχείρισης χρόνου και αποδοτικής μελέτης, με κύριο στόχο την ενίσχυση της αυτορρύθμισης και την ανάπτυξη των μεταγνωστικών ικανοτήτων των μαθητών.
